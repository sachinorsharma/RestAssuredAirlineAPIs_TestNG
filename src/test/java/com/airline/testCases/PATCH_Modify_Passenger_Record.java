 ...
 *
 */
public class PATCH_Modify_Passenger_Record extends TestBase
{
	...
	{
		logger.info("<---------------- Started testing of PATCH_Modify_Passenger_Record ------------->");
		
		RestAssured.baseURI = "https://api.instantwebtools.net/v1/passenger/";	// End point to modify passenger
...
//		passengerID = "6289e594d0ea33dc03e8df5c";
		...
		response = httpRequest.request(Method.PATCH, passengerID);
	...
	{
		logger.info("<---------------- Finished testing of PATCH_Update_Passenger_Record ------------->\"");
	}
